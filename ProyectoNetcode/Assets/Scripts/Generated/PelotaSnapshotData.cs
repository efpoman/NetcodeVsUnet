...
public struct PelotaSnapshotData : ISnapshotData<PelotaSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref PelotaSnapshotData baseline1, ref PelotaSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref PelotaSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref PelotaSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref PelotaSnapshotData target, float factor)
    {
