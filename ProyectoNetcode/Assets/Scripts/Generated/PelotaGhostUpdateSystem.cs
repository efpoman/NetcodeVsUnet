...
public class PelotaGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<PelotaSnapshotData> ghostSnapshotDataType;
...
#endif
                PelotaSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<PelotaSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<PelotaSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<PelotaSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<PelotaSnapshotData>(true),
...
public partial class PelotaGhostSpawnSystem : DefaultGhostSpawnSystem<PelotaSnapshotData>
{
}
